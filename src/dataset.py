...
class MDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.token_type_ids is not None:
            ...
            # T5 specific tokenisation handling
            if 'T5' in self.tokenizer.name_or_path or 'distilbert' in self.tokenizer.name_or_path:
        ...
        if not 'T5' in self.tokenizer.name_or_path:
